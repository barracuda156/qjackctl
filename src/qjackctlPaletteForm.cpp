...
#include "ui_qjackctlPaletteForm.h"
...
qjackctlPaletteForm::qjackctlPaletteForm ( QWidget *parent, const QPalette& pal )
	: QDialog(parent), p_ui(new Ui::qjackctlPaletteForm), m_ui(*p_ui)
{
	m_ui.setupUi(this);
...
qjackctlPaletteForm::~qjackctlPaletteForm (void)
{
	setSettings(nullptr);
}


void qjackctlPaletteForm::setPalette ( const QPalette& pal )
{
	m_palette = pal;
...
void qjackctlPaletteForm::setPalette ( const QPalette& pal, const QPalette& parentPal )
{
...
const QPalette& qjackctlPaletteForm::palette (void) const
{
	return m_palette;
}


void qjackctlPaletteForm::setSettings ( QSettings *settings, bool owner )
{
...
QSettings *qjackctlPaletteForm::settings (void) const
{
	return m_settings;
}
...
void qjackctlPaletteForm::saveButtonClicked (void)
{
...
void qjackctlPaletteForm::deleteButtonClicked (void)
{
	const QString& name = m_ui.nameCombo->currentText();
...
void qjackctlPaletteForm::generateButtonChanged (void)
{
	const QColor& color
...
void qjackctlPaletteForm::resetButtonClicked (void)
{
...
void qjackctlPaletteForm::detailsCheckClicked (void)
{
...
void qjackctlPaletteForm::importButtonClicked (void)
{
	const QString& title
		...
		if (!name.isEmpty()) {
			...
			while (iter.hasNext()) {
				...
				const QPalette::ColorRole cr
					= qjackctlPaletteForm::colorRole(key);
...
void qjackctlPaletteForm::exportButtonClicked (void)
{
	const QString& title
...
void qjackctlPaletteForm::paletteChanged ( const QPalette& pal )
{
	m_modelUpdated = true;
	if (!m_paletteUpdated)
		setPalette(pal);
...
void qjackctlPaletteForm::setPaletteName ( const QString& name )
{
...
QString qjackctlPaletteForm::paletteName (void) const
{
	return m_ui.nameCombo->currentText();
}


void qjackctlPaletteForm::updateNamedPaletteList (void)
{
	const bool blocked = m_ui.nameCombo->blockSignals(true);
...
void qjackctlPaletteForm::updateGenerateButton (void)
{
...
void qjackctlPaletteForm::updateDialogButtons (void)
{
	const QString& name = m_ui.nameCombo->currentText();
...
bool qjackctlPaletteForm::namedPalette ( const QString& name, QPalette& pal )
{
	return namedPalette(m_settings, name, pal);
}


bool qjackctlPaletteForm::namedPalette (
...
void qjackctlPaletteForm::saveNamedPalette (
...
void qjackctlPaletteForm::deleteNamedPalette ( const QString& name )
{
	if (m_settings) {
		m_settings->beginGroup(ColorThemesGroup);
...
QStringList qjackctlPaletteForm::namedPaletteList (void)
{
	return namedPaletteList(m_settings);
}


QStringList qjackctlPaletteForm::namedPaletteList ( QSettings *settings )
{
	QStringList list;
...
QPalette::ColorRole qjackctlPaletteForm::colorRole ( const QString& name )
{
...
bool qjackctlPaletteForm::isDirty (void) const
{
	return (m_dirtyTotal > 0);
}


void qjackctlPaletteForm::accept (void)
{
...
void qjackctlPaletteForm::reject (void)
{
	if (m_dirtyCount > 0) {
...
void qjackctlPaletteForm::setDefaultDir ( const QString& dir )
{
	if (m_settings) {
...
QString qjackctlPaletteForm::defaultDir (void) const
{
	QString dir;
...
void qjackctlPaletteForm::setShowDetails ( bool on )
{
	if (m_settings) {
		m_settings->beginGroup(PaletteEditorGroup);
...
bool qjackctlPaletteForm::isShowDetails (void) const
{
	bool on = false;
...
void qjackctlPaletteForm::showEvent ( QShowEvent *event )
{
...
void qjackctlPaletteForm::resizeEvent ( QResizeEvent *event )
{
...
//-------------------------------------------------------------------------
// qjackctlPaletteForm::PaletteModel

qjackctlPaletteForm::PaletteModel::PaletteModel ( QObject *parent )
...
int qjackctlPaletteForm::PaletteModel::rowCount ( const QModelIndex& ) const
{
	return m_nrows;
}


int qjackctlPaletteForm::PaletteModel::columnCount ( const QModelIndex& ) const
{
	return 4;
}


QVariant qjackctlPaletteForm::PaletteModel::data ( const QModelIndex& index, int role ) const
{
	if (!index.isValid())
		return QVariant();
...
bool qjackctlPaletteForm::PaletteModel::setData (
...
Qt::ItemFlags qjackctlPaletteForm::PaletteModel::flags ( const QModelIndex& index ) const
{
	if (!index.isValid())
...
QVariant qjackctlPaletteForm::PaletteModel::headerData (
...
const QPalette& qjackctlPaletteForm::PaletteModel::palette(void) const
{
	return m_palette;
}


void qjackctlPaletteForm::PaletteModel::setPalette (
...
QPalette::ColorGroup qjackctlPaletteForm::PaletteModel::columnToGroup ( int index ) const
{
	if (index == 1)
...
int qjackctlPaletteForm::PaletteModel::groupToColumn ( QPalette::ColorGroup group ) const
{
...
//-------------------------------------------------------------------------
// qjackctlPaletteForm::ColorDelegate

QWidget *qjackctlPaletteForm::ColorDelegate::createEditor ( QWidget *parent,
...
void qjackctlPaletteForm::ColorDelegate::setEditorData (
...
void qjackctlPaletteForm::ColorDelegate::setModelData ( QWidget *editor,
...
void qjackctlPaletteForm::ColorDelegate::updateEditorGeometry ( QWidget *editor,
...
QSize qjackctlPaletteForm::ColorDelegate::sizeHint (
	const QStyleOptionViewItem& option, const QModelIndex &index) const
{
...
//-------------------------------------------------------------------------
// qjackctlPaletteForm::ColorButton

qjackctlPaletteForm::ColorButton::ColorButton ( QWidget *parent )
...
const QBrush& qjackctlPaletteForm::ColorButton::brush (void) const
{
	return m_brush;
}


void qjackctlPaletteForm::ColorButton::setBrush ( const QBrush& brush )
{
	m_brush = brush;
	update();
}
...
void qjackctlPaletteForm::ColorButton::paintEvent ( QPaintEvent *event )
{
...
void qjackctlPaletteForm::ColorButton::chooseColor (void)
{
	const QColor color
...
//-------------------------------------------------------------------------
// qjackctlPaletteForm::ColorEditor

qjackctlPaletteForm::ColorEditor::ColorEditor ( QWidget *parent )
	: QWidget(parent)
{
...
void qjackctlPaletteForm::ColorEditor::setColor ( const QColor& color )
{
...
QColor qjackctlPaletteForm::ColorEditor::color (void) const
{
	return m_button->brush().color();
}


void qjackctlPaletteForm::ColorEditor::colorChanged (void)
{
	m_changed = true;
	emit changed(this);
}
...
bool qjackctlPaletteForm::ColorEditor::changed (void) const
{
	return m_changed;
}
...
//-------------------------------------------------------------------------
// qjackctlPaletteForm::RoleEditor

qjackctlPaletteForm::RoleEditor::RoleEditor ( QWidget *parent )
	: QWidget(parent)
{
	m_edited = false;
...
void qjackctlPaletteForm::RoleEditor::setLabel ( const QString& label )
{
	m_label->setText(label);
}


void qjackctlPaletteForm::RoleEditor::setEdited ( bool on )
{
	QFont font;
	if (on)
		font.setBold(on);
...
bool qjackctlPaletteForm::RoleEditor::edited (void) const
{
	return m_edited;
}


void qjackctlPaletteForm::RoleEditor::resetProperty (void)
{
	setEdited(false);
	emit changed(this);
}
...
// end of qjackctlPaletteForm.cpp
